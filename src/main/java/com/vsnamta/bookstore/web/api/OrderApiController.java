...
public class OrderApiController {
    ...
    public OrderDetailResult save(@Valid @RequestBody OrderSavePayload orderSavePayload, @AuthenticationPrincipal CustomUser customUser) {
    ...
    public OrderDetailResult update(@PathVariable Long id, @Valid @RequestBody OrderUpdatePayload orderUpdatePayload, @AuthenticationPrincipal CustomUser customUser) {
